...
const text = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        '메뉴의 \'디스코드로 알림받기\'를 눌러서 서버에 참여하면 끝이에요. 로그인이나 개인정보 입력은 전혀 필요 없습니다. 서버에 들어오면 홈페이지, 이캠퍼스, 샘물, Office 365, 학생생활관, 수강신청 채널이 각각 나뉘어 있고, 기본적으로 전부 알림이 켜진 상태로 시작해요.',
    },
    {
      question: '관심 있는 사이트 알림만 골라서 받을 수 있나요?',
      answer:
        '네. 사이트마다 채널이 따로 있어서, 신경 안 쓰는 사이트의 채널만 뮤트해두면 그 사이트 알림만 안 옵니다. 반대로 전부 받고 싶으면 아무것도 안 건드리셔도 돼요.',
    },
    {
    ...
    },
    {
      ...
      answer:
        '아니요, 알림 채널은 공지 전용이라 저(운영자)만 글을 올릴 수 있어요. 서버 자체가 잡담이나 소통 목적이 아니라 알림만 받아보는 용도로 만들어져 있어서, 채널 성격에 안 맞는 대화는 오갈 수 없는 구조예요.',
    },
  ],
