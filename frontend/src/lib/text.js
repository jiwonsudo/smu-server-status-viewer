...
const text = {
  ...
  about: {
    ...
    colorDown: '비정상 — 10초 넘게 응답이 없거나 실제 서버 장애가 있는 경우',
    detailHint: "각 카드의 '상세 상태 보기'를 누르면 응답 시간을 비롯한 정보들을 자세히 볼 수 있어요.",
    aiHeading: 'AI 장애 패턴 분석',
    aiBody:
      "'상세 상태 보기'에는 그 서비스의 최근 장애 이력과 평균 복구 시간이 함께 나와요. 장애가 감지된 상태라면, 과거에 비슷한 시간대·시기에 있었던 장애 기록을 근거로 이번 장애가 금방 풀릴 일시적인 것인지 오래갈 것인지를 AI가 추정해서 보여줘요.",
  ...
  faq: [
    ...
    {
      question: "'상세 상태 보기'에 나오는 AI 분석은 뭔가요?",
      answer:
        '서버에 장애가 감지되면, 그 서비스의 과거 장애 기록(주로 언제 발생했고 복구까지 얼마나 걸렸는지)을 근거로 이번 장애가 금방 풀릴 일시적인 것인지 오래갈 것인지를 AI가 추정해서 알려드려요. 과거 데이터에 없는 내용은 추측하지 않고, 기록이 아직 적을 땐 "판단 보류"로 표시해요. 정상일 때도 그 서비스의 최근 장애 이력은 볼 수 있어요.',
    },
  ],
