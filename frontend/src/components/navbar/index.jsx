...
import LOGO from '../../assets/smuon_white.webp';
import NavMenu from './NavMenu';
import text from '../../lib/text';

const Navbar = () => {
  return (
    <header className="sticky top-0 z-40 flex w-full items-center justify-between gap-2 border-b border-white/10 bg-primary px-3 py-2.5 sm:px-6">
      <Link href="/" className="flex min-w-0 shrink items-center gap-2.5 sm:gap-3">
        <div className="flex h-11 w-11 shrink-0 items-center justify-center sm:h-12 sm:w-12">
          ...
          <img src={LOGO.src} alt={text.site.logoAlt} className="h-full w-full object-contain" />
        </div>
